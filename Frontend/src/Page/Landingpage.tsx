    ...
    <div className="w-full h-[70px] bg-gray-800 opacity-80 flex items-center justify-between z-10 relative px-4">
      <div className="text-white text-2xl">
        <img
          src={hello}
          alt="Logo"
          className="h-36 w-auto mt-4 filter brightness-200 contrast-175"
        />
      </div>
...
export default function Landingpage() {
  return (
    <div className="w-full h-screen relative bg-white">
      <Navbar />
      <img
        className="w-full h-auto left-0 top-0 absolute z-0"
        src="https://img.freepik.com/premium-photo/womans-hands-swiftly-typing-glowing-laptop-keyboard_795422-14493.jpg"
        alt="Landing background"
      />

      <div>
        <div className="w-[40%] h-[50%] left-[75%] top-[70%] absolute opacity-80 bg-gray-500 rounded-[22px] border border-black transform -translate-x-1/2 -translate-y-1/2">
          <Landingpage2 />
        </div>

        <div className="w-[43%] h-[10%] left-[5%] top-[20%] absolute text-center flex flex-col items-center">
          <motion.span
            className="text-white text-7xl font-semibold leading-[64px] tracking-widest transition-all duration-500 ease-in-out transform hover:text-blue-600 hover:scale-110 hover:tracking-wider hover:shadow-lg hover:shadow-blue-900"
        ...
        <div className="w-[43%] h-[10%] left-[18%] top-[30%] absolute text-center flex flex-col items-center">
          <motion.span
            className="text-red-100 text-[34px] font-normal leading-[64px] tracking-wide mt-2 transition-all  duration-500 ease-in-out transform hover:text-gray-500 hover:scale-110 hover:tracking-wider hover:shadow-lg "
            style={{ fontFamily: '"Poppins", sans-serif' }}
          >
      ...
      <div className="absolute top-20 right-1 mt-10 mr-20 text-5xl font-semibold text-white">
        <motion.div
      ...
      <div className="relative bottom-10 mt-96 ml-84 flex flex-row gap-4 z-10">
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
      ...
      <footer className=" w-full bg-gray-800 mt-36 text-white py-4 ">
